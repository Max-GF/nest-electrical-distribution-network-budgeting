...
export function EditPoleScrewResponse() {
  return applyDecorators(
    ApiOperation({
      summary: "Edit a pole screw",
    }),
    ApiResponse({
      status: HttpStatus.OK,
      description: "The pole screw has been successfully updated.",
      schema: {
        type: "object",
        properties: {
          message: {
            type: "string",
            example: "Pole screw updated successfully",
          },
          poleScrew: {
            type: "object",
            properties: {
    ...
    ApiResponse({
      ...
      description: "Pole screw code already registered or not found",
      schema: {
        example: {
